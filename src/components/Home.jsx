export default function Home() {
  return (
    <div id='home' className="h-screen flex flex-col justify-center items-center">
      ...
      <p className="text-blue-200 px-10 sm:max-w-[600px] lg:max-w-[700px] lg:text-xl">I'm a passionate Front-End Developer with a strong focus on creating responsive, user-friendly, and visually appealing web applications. Eager to improve myself, I constantly explore new technologies and best practices to enhance my skills. I enjoy turning ideas into reality with clean and efficient code, striving to build seamless digital experiences.</p>
    </div>
  );
}
